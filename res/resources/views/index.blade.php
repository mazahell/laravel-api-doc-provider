...
<head>
    <meta charset="UTF-8">
    <title>{{ env("SITE_NAME") ? env("SITE_NAME") : "DocAPI" }}</title>
    <meta name="viewport" content="width=device-width,initial-scale=1">

    <link href="{{ url('api/css/style.min.css') }}" rel="stylesheet"/>
...
<script src="{{ url('api/plugins/angular.min.js') }}" type="text/javascript"></script>
<script src="{{ url('api/js/etsApiApp.module.js') }}" type="text/javascript"></script>
<script src="{{ url('api/js/etsApiApp.controller.js') }}" type="text/javascript"></script>
